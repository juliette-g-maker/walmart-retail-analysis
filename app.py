...
PLOTLY_LAYOUT = dict(
    plot_bgcolor="white",
    paper_bgcolor="white",
    font=dict(family="Arial, sans-serif", color="#262626"),
...
# --- Effet fêtes + promotions côte à côte ---
...
with col_a:
    ...
    if True in pivot.columns and False in pivot.columns:
        ...
        fig2.update_layout(**PLOTLY_LAYOUT, yaxis_title="% d'augmentation", xaxis_title="Type")
